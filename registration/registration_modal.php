                    ...
                    <div class="container-fluid">
                        <form id="registration_form" action="">
                            ...
                            <div class='row form-group'>
                                ...
                                <div class='col-auto'>
                                    <label class='control-label' style='position:relative; top:7px;'>Please Enter Your Username:</label>
                                </div><br>
                                <div class='col-auto'>
                                ...
                                <div class='col-auto'>
                                    <label class='control-label' style='position:relative; top:7px;'>Please Enter Your Email Address:</label>
                                </div><br>
                                <div class='col-auto'>
                                ...
                                <div class='col-auto'>
                                    <label class='control-label' style='position:relative; top:7px;'>Please Choose Your Account User Type In The Following:</label>
                                </div><br>
                                <div class='col-auto'>
                                    <div id="adminButton" style='display:none'>
                                        <input type="radio" id="userType" name="userType" value="0" required> Admin
                                    </div>
                                    <input type="radio" id="userType" name="userType" value="1" required> Seller
                                    <input type="radio" id="userType" name="userType" value="2" required> Buyer
                                </div> 
                            </div>
