...
<div id="myNav" class="overlay">
  ...
  <div style="display:block;">
    <div style="display:inline;"><iframe width="50%" height="400" style="float:right;" src="https://www.youtube.com/embed/LKR0TM_yliQ" 
      frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
      <div style="display:inline;"height="100%" width="50%"><br><br><br><h1>Explore</h1><br><br><br><br><br><br></div>
  </div>
  <div style="display:block;">
    <div style="display:inline;"><img src="./image/polyU005.jpg" style="float:left;" height="100%" width="50%" tabindex="1"></div>
    <div style="display:inline;"height="100%" width="50%"><br><br><br><h1>Our teams</h1><br><p>Amayon was established in 2019. It is made up of a group of University students.</p><br><br><br><br></div>
  </div>
  <div style="display:block;">
    <div style="display:inline;"><img src="./image/polyU002.jpg" style="float:right;" height="100%" width="50%" tabindex="1"></div>
    <div style="display:inline;"height="100%" width="50%"><br><br><br><h1>Goal and Mission</h1><br><p>We would like to build a sustainability platform to both customer and seller. "Connecting people" is our goal.</p><br><br><br></div>
  </div>
  <div style="display:block;">
    <div style="display:inline;"><img src="./image/polyU004.jpg" style="float:left;" height="100%" width="50%" tabindex="1"></div>
    <div style="display:inline;"height="100%" width="50%"><br><br><h1>Services</h1><br><p>"Now that's not buying happiness. That's just buying off unhappiness." Your may go shopping anytime via Amayon. </p><br></div>
  </div>
  <div style="display:block;">
    <div style="display:inline;"><img src="./image/polyU001.jpg" style="float:right;" height="100%" width="50%" tabindex="1"></div>
    <div style="display:inline;"height="100%" width="50%"><br<br><br><h1>Job Opportunity and Cooperation</h1><br><p>Here is the opportunity to grow your skills and achieve your goals. We also widely welcome new seller to join Amayon.</p><br><br><br><br></div>
  </div>
  </div>
</body>
<script type="text/javascript">
