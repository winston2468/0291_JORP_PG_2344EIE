<!DOCTYPE html>
<html>
<!-- source code from http://tutorialzine.com/2016/11/simple-credit-card-validation-form/-->
            ...
            <div class="payment">
                <form>
                    ...
                    <div class="form-group" id="credit_cards">
                        <img src="cart/assets/images/visa.jpg" id="visa">
                        <img src="cart/assets/images/mastercard.jpg" id="mastercard">
                        <img src="cart/assets/images/amex.jpg" id="amex">
                    </div>
    ...
    $(function() {
        ...
        confirmButton.click(function(e) {
            ...
            if (owner.val().length < 5) {
                alert("Owner Name too short");
            } else if (!isCardValid) {
                alert("Wrong card number format");
            } else if (!isCvvValid) {
                alert("Wrong CVV");
            } else {

                $('#buy_hidden').trigger('click');
